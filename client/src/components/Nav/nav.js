...
function Nav() {
    ...
    useEffect(() => {
        API.userInfo().then((response) => {
            ...
            var badgeNumber = response.data[0].unRead
            console.log("THIS IS THE RESPONSE AFTER API.USER INFO")
            ...
            <Layout fixedHeader className="nav-layout" style={{ position: 'relative', maxHeight: "320px", backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                ...
                <Header transparent >
                    ...
                    <Navigation>
                        ...
                        <a className="match-nav" href="/matches"><Badge text={badgeNumber}>Matches</Badge></a>
